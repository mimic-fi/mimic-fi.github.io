  ...
  return (
    ...
    <Box w="full" className={styles.page}>
        <Flex direction={'column'} align="center" p={[0, 6, 8]} w="full">
          ...
          <Heading>
              MIMIC TERMS & CONDITION
          </Heading>
<Text py="6">
Welcome to https://mimic.fi, a website-hosted user interface (the “Interface” or “App”) provided by Mimic Team. (“we”, “our”, or “us”). The Interface provides access to a decentralized tool to manage defi treasuries in a trustless way (the “Protocol”).

This Terms of Service Agreement (the “Agreement”) explains the terms and conditions by which you may access and use the Interface. You must read this Agreement carefully. By accessing, joining any strategy or using the Interface, you signify that you have read, understand, and agree to be bound by this Agreement in its entirety. If you do not agree, you are not authorized to access or use the Interface. Exit now.
...
We reserve the right, in our sole discretion, to modify this Agreement from time to time. If we make any modifications, we will notify you by updating the date at the top of the Agreement and by maintaining a current version of the Agreement at https://mimic.fi/terms. All modifications will be effective when they are posted, and your continued use of the Interface will serve as confirmation of your acceptance of those modifications. If you do not agree with any modifications to this Agreement, you must immediately stop accessing and using the Interface and the protocol.
<Heading size="md" >
...
F. Any Other Unlawful Conduct. Activity that violates any applicable law, rule, or regulation of the United States or another relevant jurisdiction, including (but not limited to) the restrictions and regulatory requirements imposed by U.S. law.
<Heading size="md" >
